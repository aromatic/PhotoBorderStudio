...
public class ImageCompareDialog {
    ...
    public void show() {
        ...
        if (dialog == null) {
            ...
            previewBox.setMaxSize(Double.MAX_VALUE, Double.MAX_VALUE);

            // Le due aree della finestra devono occupare ciascuna metà
            ...
            markerCanvas.heightProperty().bind(previewBox.heightProperty());
    ...
    public void reset() {
        ...
        image1Toggle.setGraphic(null);
        image2Toggle.setGraphic(null);

        image1Toggle.setText("");
        image2Toggle.setText("");

        image1Toggle.setSelected(false);
        image2Toggle.setSelected(false);
